...
export const documentedBosses: DocumentedBoss[] = [
  ...
  {
    name: "Igris",
    context: "Boss de evento/desafio com HP na casa de 1,02B",
    skills: [
    ...
    notes: "Na run registrada, Shadow Wolf concentrou o dano (104,86M) enquanto o time inteiro caía durante o Rage Mode.",
