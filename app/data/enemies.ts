export const newlyDocumentedEnemies = [
  ...
  { name: "Hardshell Rhinoceros Beetle", skill: "Iron Steel Shell", effect: "Imune a efeitos de Calamity — counter direto para Sword Demon e Lilith. Uma fala de inimigo em batalha reforça: “My shell is completely immune to the Calamity buff!”.", confidence: "confirmada na tela" },
