...
export const heroes: HeroRecord[] = [
  ...
  },
  {
    slug: "sword-demon",
    name: "Sword Demon",
    aliases: ["Demon King — apelido informal usado pelo jogador"],
    className: "Calamity",
    rarity: "SP",
    role: "Dano em área / Fear / sustain",
    summary: "Carregador de linha de frente que multiplica Blade Storm por meio de clones e transforma Fear em dano contínuo.",
    fieldNote: "Observado no nível 12. Duas runs distintas terminaram praticamente no mesmo patamar: 23,79M e 23,96M de dano, indicando consistência da construção de clones.",
    stats: [
      "Nível observado: 12",
      "Poder observado: 19.604",
      "Ataque observado: 14,7K",
      "HP observado: 262,09K",
      "Defesa observada: 9.241",
      "Recompensa global observada: Dano Crítico +19,2%",
    ],
    levelSkills: [],
    ...
    evidence: ["Ficha comparativa no nível 12", "Run andar 15: 23,79M", "Segunda run andar 15: 23,96M"],
    ...
    pending: ["Mapear as habilidades gratuitas por nível", "Medir quanto do dano final vem de Fear e quanto vem de Blade Storm"],
  },
  {
