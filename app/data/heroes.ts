...
export const heroes: HeroRecord[] = [
  ...
  {
    slug: "sword-demon", name: "Sword Demon", className: "Corpo a corpo", role: "Dano em área / Fear / sustain",
    summary: "Carregador de linha de frente que multiplica Blade Storm por meio de clones e transforma Fear em dano contínuo.",
    fieldNote: "Duas runs distintas terminaram praticamente no mesmo patamar: 23,79M e 23,96M de dano, indicando consistência da construção de clones.",
    levelSkills: [],
    builds: [{ name: "Clone + Blade Storm + Fear", status: "confirmada", summary: "O clone periódico replica Blade Storm, que passa a causar Fear e recuperar HP.", priorities: ["Many Shadows", "Bloody Swordsmanship", "Dreadblade", "Fear Attacks", "Fear Abyss"] }],
    synergies: ["Onmyoji para escudo e redução de dano", "Invocações que congestionam o campo", "Shadow Wolf para finalizar bosses abaixo de 50% de HP"],
    evidence: ["Run andar 15: 23,79M", "Segunda run andar 15: 23,96M"],
    evidenceImages: [{ src: "/screenshots/runs/summon-army-sword-demon.jpg", alt: "Build de clones e Fear do Sword Demon" }, { src: "/screenshots/runs/marksman-counter-result.jpg", alt: "Sword Demon encerra a segunda run com 23,96M" }],
    pending: ["Registrar a raridade e a classe oficial", "Mapear as habilidades gratuitas por nível", "Medir quanto do dano final vem de Fear e quanto vem de Blade Storm"],
  },
  {
