...
export const lilith: HeroRecord = {
  ...
  storyImages: [
    ...
    { src: "/screenshots/lilith/story-crops/story-6-gem-unlock.jpg", title: "Story 6 · gemas", caption: "A mesma Story 6 também apareceu com opção de compra por 20 gemas." },
  ],
  stats: [
