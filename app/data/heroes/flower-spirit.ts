...
export const flowerSpirit: HeroRecord = {
  ...
  levelSkills: [
    ...
    { name: "Bestiary — Flowers in full bloom", description: "Extra health recovery — recuperação extra de vida.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p1-1.jpg" },
    { name: "Bestiary — tough mosaic", description: "Increase the duration of mosaic and leaves — aumenta a duração de 'mosaic and leaves'.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p1-2.jpg" },
    { name: "Bestiary — petals guard", description: "Provides additional shield — fornece escudo adicional.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p1-3.jpg" },
    { name: "Bestiary — sharp mosaic leaves", description: "Mosaic and leaves additionally increases critical hit rate — as folhas também aumentam a taxa de crítico.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p1-4.jpg" },
    { name: "Bestiary — Flower Shadow Twins", description: "Flower Spirit Blessing takes effect on target +1 — a habilidade passa a afetar um alvo adicional.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p2-1.jpg" },
    { name: "Bestiary — Spreading mosaic leaves", description: "Mosaic and leaves have a probability of spreading to nearby friendly forces — as folhas têm chance de se espalhar para aliados próximos.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p2-2.jpg" },
    { name: "Bestiary — Nourishing stamens", description: "When an ally has low health, the flower spirit will consume part of its own health and immediately release the blessing of the flower spirit to the ally — com aliado em vida baixa, consome parte da própria vida para liberar a bênção imediatamente nele.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p2-3.jpg" },
    { name: "Bestiary — Free of control mosaics and leaves", description: "Mosaic and leaves provide control-free effect — as folhas concedem imunidade a controle.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p2-4.jpg" },
    { name: "Bestiary — The Blessing of the Flower God", description: "When an ally dies for the first time, the flower spirit will consume part of its health to resurrect it — na primeira morte de um aliado, consome parte da própria vida para ressuscitá-lo.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p3-1.jpg" },
    { name: "Bestiary — Protective Mosaic Leaves", description: "Floral Leaf additionally purifies negative effects — Floral Leaf também purifica efeitos negativos.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p3-2.jpg" },
    { name: "Bestiary — Abundance (dourada)", description: "After releasing three skills, Hua Ling will heal all allies and add a shield — após liberar três habilidades, Hua Ling cura todos os aliados e adiciona escudo. (O texto usa o nome 'Hua Ling' para a heroína.)", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p3-3.jpg" },
    { name: "Bestiary — flower rain (dourada)", description: "Releasing the skill will apply mosaic and leaves to all allies — usar a habilidade aplica 'mosaic and leaves' em todos os aliados.", source: "Blessing Bestiary" , image: "/screenshots/bencaos/flower-spirit/p3-4.jpg" },
